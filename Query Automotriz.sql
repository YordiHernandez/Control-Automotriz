...
DPI_UClientes VARCHAR(13) NOT NULL,
fk_Id_Cliente INT,
...
DPI_UEmpleado VARCHAR(13) NOT NULL,
fk_Id_Empleado INT,
...
Comentario_Cotizacion VARCHAR (128) NOT NULL,
...
fk_Id_Cliente_Citas INT NOT NULL,
PRIMARY KEY(`pk_Id_Citas`),
FOREIGN KEY (`fk_Id_Cliente_Citas`) REFERENCES `Cliente` (`pk_Id_Cliente`)
)ENGINE = InnoDB DEFAULT CHARACTER SET = utf8;
...
pk_id_banco INT AUTO_INCREMENT NOT NULL,
Fecha_banco VARCHAR (10) NOT NULL,
Tipo_banco VARCHAR (12) NOT NULL,
Cantidad_banco DOUBLE NOT NULL,
fk_Id_Citas_banco INT NOT NULL,
PRIMARY KEY(`pk_id_banco`),
FOREIGN KEY (`fk_Id_Citas_banco`) REFERENCES `Citas` (`pk_Id_Citas`)
)ENGINE = InnoDB DEFAULT CHARACTER SET = utf8;
